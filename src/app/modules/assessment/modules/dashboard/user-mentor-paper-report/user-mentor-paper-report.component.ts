...
@Component({
  selector: 'app-user-mentor-paper-report',
  templateUrl: './user-mentor-paper-report.component.html',
  styleUrls: ['./user-mentor-paper-report.component.scss']
})
export class UserMentorPaperReportComponent implements OnInit {
