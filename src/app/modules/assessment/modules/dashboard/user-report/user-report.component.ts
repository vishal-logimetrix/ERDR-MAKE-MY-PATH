    ...
    .subscribe(
      data => {
        ...
        if (data['paper_type'] == 'practice') {
          this.router.navigate([`/assessment/paper/practice-paper/${this.paperDetails['learner_exam']['exam']['id']}`],{
            queryParams: {
              paper: data['id']
            }
          });
          ...
          this.openNewPaper(this.paperDetails['learner_exam']['exam']['id'], data['id']);
        }
      },
      error => {
        console.log("error ", error);
      ...
      data => {
        ...
        for (let i = 0; i < this.reportObj['report_data']['chapters'].length; i++) {
          ...
          if (this.reportObj['report_data']['chapters'][i]['attempted'] > this.reportObj['report_data']['chapters'][i]['unchecked']) {
            ...
            if (this.reportObj['report_data']['chapters'][i]['percentage'] >= this.paperDetails['learner_exam']['exam']['excellent_low'] && this.reportObj['report_data']['chapters'][i]['percentage'] <= this.paperDetails['learner_exam']['exam']['excellent_high']) {
            ...
            if (this.reportObj['report_data']['chapters'][i]['percentage'] >= this.paperDetails['learner_exam']['exam']['average_low'] && this.reportObj['report_data']['chapters'][i]['percentage'] <= this.paperDetails['learner_exam']['exam']['average_high']) {
            ...
            if (this.reportObj['report_data']['chapters'][i]['percentage'] < this.paperDetails['learner_exam']['exam']['poor']) {
              if (!this.poorChapter) {
