...
@Component({
  selector: 'app-mentor-paper',
  templateUrl: './mentor-paper.component.html',
  styleUrls: ['./mentor-paper.component.scss']
})
export class MentorPaperComponent implements OnInit, OnDestroy {
