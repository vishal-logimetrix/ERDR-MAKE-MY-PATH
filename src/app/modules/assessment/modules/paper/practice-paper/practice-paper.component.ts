...
@Component({
  selector: 'app-practice-paper',
  templateUrl: './practice-paper.component.html',
  styleUrls: ['./practice-paper.component.scss']
})
export class PracticePaperComponent implements OnInit {
