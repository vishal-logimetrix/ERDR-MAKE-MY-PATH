...
@Component({
  selector: 'app-mentor-paper-instructions',
  templateUrl: './mentor-paper-instructions.component.html',
  styleUrls: ['./mentor-paper-instructions.component.scss']
})
export class MentorPaperInstructionsComponent implements OnInit {
  ...
  getTestInstructions() {
    this.networkRequest.getWithHeaders(`/api/mentorpaperinstructions/?paper=${this.paperId}`)
    .subscribe(
      data => {
