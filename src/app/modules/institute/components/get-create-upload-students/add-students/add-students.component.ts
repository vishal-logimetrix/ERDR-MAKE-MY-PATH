  ...
  submitCSV() {
    ...
    if (csvFile) {
      ...
      fileData.append("csv_file", csvFile);
        this.instituteService.bulkPackageUpdateStudents(fileData).subscribe(
          data => {
            console.log("Students package updated successfully ", data);
            this.successMsg = "Students  package updated successfully. ";
          },
          error => {
